...
def get_row_envelopes(coefs, max_points, min_points):
    ...
    for row in range(num_rows):
        row_data = coefs[row, :]
        # print(f"Row {row}, data shape: {row_data.shape}, min: {row_data.min()}, max: {row_data.max()}")
        ...
        # print(f"Row {row}, max_points: {len(row_max_points)}, min_points: {len(row_min_points)}")
        ...
        # print(f"Row: {row}, верхняя огибающая {len(upper_max_points)}, нижняя огибающая {len(lower_min_points)}")
...
def get_column_envelopes(coefs, max_points, min_points):
    ...
    for col in range(num_cols):
        col_data = coefs[:, col]
        #print(f"Col {col}, data shape: {col_data.shape}, min: {col_data.min()}, max: {col_data.max()}")
        ...
        #print(f"Col {col}, max_points: {len(col_max_points)}, min_points: {len(col_min_points)}")
        ...
        #print(f"Col: {col}, верхняя огибающая {len(upper_max_points)}, нижняя огибающая {len(lower_min_points)}")
