...
class ExtremesFinder:
    ...
    def find_extremes_gpu(coefs_gpu, row_var, col_var, max_var, min_var):
        """GPU extrema detection with typed CUDA infrastructure failures."""
        try:
            import cupy as cp
            ...
            if row_var and (max_var or min_var):
                ...
                if max_var:
                    ...
                    if cp.any(max_mask):
                        ...
                        points_max_by_row = [
                            [int(x + 1), int(y)] for y, x in zip(max_y, max_x)
                        ]
                ...
                if min_var:
                    ...
                    if cp.any(min_mask):
                        ...
                        points_min_by_row = [
                            [int(x + 1), int(y)] for y, x in zip(min_y, min_x)
                        ]
            ...
            if col_var and (max_var or min_var):
                ...
                if max_var:
                    ...
                    if cp.any(max_mask):
                        ...
                        max_x = max_coords[1].get()
                        points_max_by_column = [
                            [int(x), int(y + 1)] for y, x in zip(max_y, max_x)
                        ]
                ...
                if min_var:
                    ...
                    if cp.any(min_mask):
                        ...
                        min_x = min_coords[1].get()
                        points_min_by_column = [
                            [int(x), int(y + 1)] for y, x in zip(min_y, min_x)
                        ]
